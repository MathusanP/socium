	...
	execute: ({ interaction, client }) => {
		...
		const embed = new MessageEmbed()
			...
			.addFields(
				...
				{ name: '**Total Commands:**', value: '3', inline: true },
		...
		const row = new MessageActionRow()
			.addComponents(
				...
				new MessageButton()
					.setStyle('LINK').setLabel('Invite the bot!').setURL('https://discord.com/api/oauth2/authorize?client_id=1035964479248281723&permissions=8&scope=applications.commands%20bot'),
			);
